    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6 order-md-2 order-first">
            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('admin/tourist-destination') }}">Wisata</a></li>
 ...
 <section id="basic-horizontal-layouts">
     <div class="card">
         ...
         <div class="card-content">
             <div class="card-body">
                 <form action="{{ url('admin/tourist-destination/'.$td->id) }}" method="POST" class="form form-horizontal" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="form-body">
                        <div class="row">
