                        ...
                        <table class="table table-lg">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                          <a href="{{ url("admin/tourist-destination/$alt->id") }}" class="btn btn-primary block">Detail</a>
                                          <a href="{{ url("admin/tourist-destination/$alt->id/edit") }}" class="btn btn-secondary block">Edit</a>
