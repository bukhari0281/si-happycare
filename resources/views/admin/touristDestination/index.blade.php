    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <a class="btn btn-outline-primary block float-end" href="{{ url('tourist-destination/create') }}">
                        Tambah Destinasi
                </a>
            </div>
                        ...
                        <table class="table table-lg">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                          <a href="{{ url("tourist-destination/$alt->id") }}" class="btn btn-primary block">Detail</a>
