 ...
 <section id="basic-horizontal-layouts">
     <div class="card">
         ...
         <div class="card-content">
             <div class="card-body">
                 <form action="{{ url('admin/fasilitas/'.$items->id) }}" method="POST" class="form form-horizontal" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="number" class="form-control" id="qty" name="qty" value="{{ $items->qty }}">
                            </div>
                            <div class="col-md-4">
