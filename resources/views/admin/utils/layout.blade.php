...
<head>
  ...
  <link rel="stylesheet" crossorigin href="{{ url('dist/assets/compiled/css/app.css') }}">
  <link rel="stylesheet" crossorigin href="{{ url('dist/assets/compiled/css/app-dark.css') }}">
  <link rel="stylesheet" crossorigin href="{{ url('dist/assets/compiled/css/iconly.css') }}">
</head>
                    ...
                    <div class="col-12 col-lg-9">
                        ...
                        <div class="row">
                            <div class="col-12 col-xl-4">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Kunjungan Berdasarkan Negara</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-7">
...
<!-- Need: Apexcharts -->
<script src="{{ url('dist/assets/extensions/apexcharts/apexcharts.min.js') }}"></script>
<script src="{{ url('dist/assets/static/js/pages/dashboard.js') }}"></script>
