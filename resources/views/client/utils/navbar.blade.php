  ...
  <header id="header" class="fixed-top">
    ...
    <div id="topbar" class="container d-flex justify-content-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope"></i> <a href="mailto:walkercfarhan@gmail.com">adminhappycare@gmail.com</a>
        <i class="bi bi-phone"></i> <a href="https://wa.me/6282211592439" target="blank">+6282211592439</a>
      </div>
